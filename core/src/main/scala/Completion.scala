...
import scala.tools.nsc.interpreter.{Completion, CompletionOutput, NamedParam, Parsed}
...
class IScalaCompletion(val intp: SparkIMain) extends Completion with CompletionOutput {
